...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      <main className="flex min-h-screen flex-col items-center justify-start bg-slate-950 bg-gradient-to-t from-slate-950 to-slate-900 py-16 text-white">
        <div>
        ...
        <div className="mb-4 mt-auto">
          <button
            ...
            className={clsx(
              "rounded-2xl",
              "bg-orange-600 px-12 py-2 text-white",
